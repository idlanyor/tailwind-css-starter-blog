        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Temukan {displayPosts.length} artikel menarik yang membahas topik{' '}
              {title.toLowerCase()}
            </p>
          </div>
        </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      {images && images.length > 0 && (
                        <div
                          className={`relative overflow-hidden ${isFirst ? 'lg:w-1/2' : 'h-48'}`}
                        >
                          <Image
                            src={images[0]}
                            alt={postTitle}
                      ...
                      <div
                        className={`p-6 ${
                          isFirst && images && images.length > 0 ? 'lg:w-1/2' : ''
                        }`}
                      >
                        {/* Date */}
                        ...
                        <h2
                          className={`font-bold leading-tight tracking-tight mb-4 ${
                            isFirst ? 'text-2xl lg:text-3xl' : 'text-xl lg:text-2xl'
                          }`}
                        >
                          <Link
                            href={`/${path}`}
